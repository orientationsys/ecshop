...
<link rel="stylesheet" href="http://47.90.87.9/setka/public.css" type="text/css" />
    ...
    <div class="box">
     <div class="box_1">
      <div style="border:4px solid #fcf8f7; background-color:#fff; padding:20px 15px;">
         ...
         　　　　　　　　　　　　　　　　　　　　　　　　　<font class="f5 f6"><?php echo htmlspecialchars($this->_var['article']['title']); ?></font><br />
         　　　　　　　　　　　　　　　　　　　　　　　<span>创建日期:<?php echo $this->_var['article']['time']; ?></span>

         <!-- <font class="f3"><?php echo htmlspecialchars($this->_var['article']['author']); ?> / <?php echo $this->_var['article']['add_time']; ?></font> -->
         </div>
         　　　　　　　　　　　<img src="<?php echo $this->_var['article']['image']; ?>" alt="" width="500px"/>
         <?php if ($this->_var['article']['content']): ?>
        　<div style="margin-left:10px;margin-right:10px;"><?php echo $this->_var['article']['content']; ?></div>
         <?php endif; ?>
