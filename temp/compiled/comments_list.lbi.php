       ...
       <div id="pagebar" class="f_r">
        ...
        <div id="pager">
          ...
          <a href="<?php echo $this->_var['pager']['page_last']; ?>"><?php echo $this->_var['lang']['page_last']; ?></a> 
            ...
            <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_34167600_1484638024');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_34167600_1484638024']):
?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_34167600_1484638024']; ?>" />
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </div>
        <?php else: ?>
         ...
         <div id="pager" class="pagebar">
          ...
          <?php $_from = $this->_var['pager']['page_number']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_34179700_1484638024');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_34179700_1484638024']):
?>
                <?php if ($this->_var['pager']['page'] == $this->_var['key']): ?>
                <span class="page_now"><?php echo $this->_var['key']; ?></span>
                <?php else: ?>
                <a href="<?php echo $this->_var['item_0_34179700_1484638024']; ?>">[<?php echo $this->_var['key']; ?>]</a>
                <?php endif; ?>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
          ...
          <?php if ($this->_var['pager']['page_kbd']): ?>
            <?php $_from = $this->_var['pager']['search']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_34194600_1484638024');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_34194600_1484638024']):
?>
            <input type="hidden" name="<?php echo $this->_var['key']; ?>" value="<?php echo $this->_var['item_0_34194600_1484638024']; ?>" />
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
...
//<![CDATA[
<?php $_from = $this->_var['lang']['cmt_lang']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'item_0_34212100_1484638024');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['item_0_34212100_1484638024']):
?>
var <?php echo $this->_var['key']; ?> = "<?php echo $this->_var['item_0_34212100_1484638024']; ?>";
<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
