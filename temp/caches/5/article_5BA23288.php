    ...
    <div class="box">
     <div class="box_1">
      <div style="border:4px solid #fcf8f7; background-color:#fff; padding:20px 15px;">
         ...
         <font class="f5 f6">开心球 第三季 3D版：开心球 预告	开心球</font><br />
         
         <!-- <font class="f3"> / </font> -->
         </div>
                   <div class="stk-post stk-layout_nocol stk-theme_1445"><p><object class="youku-video size-wide" data-video-src="http://player.youku.com/embed/XMzIzNDI5Mzg4" data-video-id="XMzIzNDI5Mzg4" data-video-provider="youku">
      <embed src="http://player.youku.com/embed/XMzIzNDI5Mzg4" type="application/x-shockwave-flash">
    </object></p></div>                           <div style="padding:8px; margin-top:15px; text-align:left; border-top:1px solid #ccc;">
