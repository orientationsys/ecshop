...
if (!$smarty->is_cached('index.dwt', $cache_id))
{
    ...
    $smarty->assign('new_articles',    news_get());   // 最新文章
...
function news_get()
{
    ...
    $header = array(
        ...
        'guest-id:67470e30-d316-11e6-8f7c-dd5a094e62dd',  

    );
    curl_setopt($oCurl, CURLOPT_URL, "http://47.90.87.9/api/v1/article");
    ...
    foreach($arr as $list=>$thing ){
      $array[$list]['id'] = $thing->id;
      $array[$list]['title'] = $thing->title;
    }
    return $array;
