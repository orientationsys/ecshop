...
function get_article($article_id)
{
    ...
    curl_setopt($oCurl, CURLOPT_URL, "http://47.90.87.9/api/v1/article/{$article_id}");
    ...
    // foreach($data as $list=>$thing ){
     $arr['content'] = $data->contentDataHtml;
     $arr['title'] = $data->title;
     $arr['time'] = date('Y-m-d h:i:s',$data->createdAt); 
     $arr['image'] = $data->previewImage->thumbnailURL;
    // }data    
     return $arr; 
}
